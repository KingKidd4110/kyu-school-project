...
$config = array(
    ...
    "key"              => "qLcfUZV0svcMaOTDvHoq2kzs3MzAjbEG", //Enter your consumer key here
...
if (isset($_POST['phone_number'])) {
    ...
    if($result['ResponseCode'] === "0"){         //STK Push request successful
        ...
        $sql = "INSERT INTO `mpesa`(`ID`, `OrderNo`, `Amount`, `phone`, `CheckoutRequestID`, `MerchantRequestID`) VALUES ('','".$orderNo."','".$amount."','".$phone."','".$CheckoutRequestID."','".$MerchantRequestID."');";
