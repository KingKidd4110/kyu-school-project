...
.button button {
  ...
  .button button i {
   ...
   <div class="container">
    ...
    <div class="price">
        <h1>Kindly Enter Payment Credentials:</h1> <!-- For testing purposes, we have added the amount manually. This should proceed from your website -->
    </div>
    <div class="card__container">
        <div class="card">
            <div class="row">
                    <img src="../img/mpesa.png" style="width:30%;margin: 0 35%;">
    ...
    <p style="color:#8F92C3;line-height:1.7;margin-top:5rem;">Thank You For Shopping with us</p>
    <li>
