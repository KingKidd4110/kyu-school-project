			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<li>
						<a href="daraja/index.php"><img src="img/m-pesa_logo.jpg"  /></a>
						</li>
						</div>
					...
					<div class="col-md-12">
						<div class="newsletter">
							...
							<ul class="newsletter-follow">
								<li>
									<a href="https://www.facebook.com/brian.ayienda.7"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://www.twitter.com/kingkid__"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
									<a href="https://www.instagram.com/king_kidd._"><i class="fa fa-instagram"></i></a>
								</li>
								<li>
									<a href="https://www.pinterest.com/ayiendabrian"><i class="fa fa-pinterest"></i></a>
								</li>
							</ul>
						</div>
					</div>
