				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<p>The best if not one of the best product in this category. You will definitely enjoy having it in your possesssion./p>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab1" class="tab-pane fade in active">
									<div class="row">
										<div class="col-md-12">
											<p>Amazing and timely. Get modern and amazing, You will defintely love being part of the brand and using the bet tailored and cheap offer for everyone.</p>
										</div>
									</div>
								</div>
								<!-- /tab1  -->
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															...
															<p class="date">25 MAR 2023, 11:0 AM</p>
														...
														<div class="review-body">
															<p>Very nice and pocket friendly. Loving it!</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">John</h5>
															<p class="date">27 FEB 2023, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
														...
														<div class="review-body">
															<p>Recommendable and lovely. </p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Brian</h5>
															<p class="date">01 APR 2023, 3:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
